...
input.addEventListener('focus',init);input.addEventListener('keyup',search);function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rego/js/groupBy-62b30ac391.min.js');loadScript('/rego/js/flexsearch-ad47a5e1ee.min.js');loadScript('/rego/js/en.search-data.min.2b5d6f1ae680cbdadcfe01f3c99371f05fe28551ec86e02597fd9bf34ce0ed1b.js',function(){input.required=false;search();});}
